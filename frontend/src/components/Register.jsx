...
//       const subject = "Login Password";
//       const body = `Use this string as your password during login for registration: ${newPassword}`;
...
//         method: "POST",
//         body: JSON.stringify({
//           studentID, name, email, password: newPassword, designation, department
//         }),
//         headers: {
//           'Content-Type': 'application/json'
//         }
...
//               <p className="mt-1 text-sm text-gray-700">Your registration was successful.</p>
//             </div>
