...
const PostForm = () =>{
    ...
    //                 </div>
    //               <button
    //                 className="mt-10 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
    //                 type="button"
    ...
    // )
    return (
      <div className='lg:w-1/4 md:w-3/4 sm:w-full'>
    
        <div className="container mx-auto p-4 md:p-6 ml-20">
          <div className="max-w-md mx-auto bg-white rounded-lg overflow-hidden">
            <div className="md:flex">
              <div className="w-full px-3 py-8 md:p-8">
                <h2 className="text-2xl font-bold text-gray-800">Create Post</h2>
                <form className="mt-6">
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      value={body}
                      onChange={(e) => setPostBody(e.target.value)}
                      className="w-full px-3 py-2 text-sm text-gray-900 bg-white border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="What's on your mind?"
                      required
                    />
                  </div>
